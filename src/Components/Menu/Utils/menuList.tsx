...
import FriendIcon from 'Assets/Icons/two-users.svg'
...
import FriendsWhiteIcon from 'Assets/Icons/two-users-white.svg'
import GroupsWhiteIcon from 'Assets/Icons/three-users-white.svg'
